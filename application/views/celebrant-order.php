...
$(document).ready(function(){
    $("#test_form").submit(function(e){     
        ...
        $.ajax({
            type: "POST",
           url : "<?php echo base_url(); ?>" +"rating/add",
            data: tdata, 
...
{
// Show Entered Value
jQuery("div#comm").show();
window.location.href=window.location.href;
}
  },
            error: function (XHR, status, that) {
              jQuery("div#error_comm").show();
			  window.location.href=window.location.href;
            }
...
<ins>
<span class="ammount">₦<?php echo $product['ownprice']; ?></span>
</ins>
</span>
...
<input type="hidden" name="price" value="<?php echo $product['ownprice']; ?>"  />
...
<?php if ($this->session->userdata('user_id') == TRUE) {?>
                        ...
                        <div class="review_grids">
							<h5>Add A Review</h5>
   <div id='comm' style='display: none' class="alert alert-success">
Thank You!  You Have Added your review.
</div>

 <div id='error_comm' style='display: none' class="alert alert-danger">
Sorry: your review could not be added
</div>
...
<div class="col-sm-4">
 ...
 <div class="col-sm-4">
    <div id="rating"> You gave a rating of <span id="count">0</span> star(s) </div>
    
    </div></div></div>
<textarea name="review" id="review" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Add Your Review';}" required="required" placeholder="Add your Review"></textarea>
<input style="display:none" type="text" name="count2" id="count2" class="count" value=""/>
<input type="hidden" name="prod_id" id="prod_id" value="<?php echo $product['prod_id']; ?>"  />
					<input id="submit" type="submit" value="Submit">
                        ...
                        <div id="review-sec">
                        you gotta login to post a review
